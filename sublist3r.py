...
def parse_args():
    ...
    parser.add_argument('-t', '--threads', help='Number of threads to use for subbrute bruteforce, default is 30', type=int, default=30)
    parser.add_argument('-e', '--engines', help='Specify a comma-separated list of search engines')
    parser.add_argument('-o', '--output', help='Save the results to text file, default is result.csv', default='result.csv')
